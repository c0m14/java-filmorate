...
CREATE TABLE USERS (
                         USER_ID INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY ON DELETE CASCADE,
...
CREATE TABLE FILM (
                        FILM_ID INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY ON DELETE CASCADE,
