...
CREATE TABLE IF NOT EXIST USER_FRIEND (
                               USER_ID INTEGER,
                               FRIEND_ID INTEGER,
...
CREATE TABLE IF NOT EXIST MPA_RATING (
...
CREATE TABLE IF NOT EXIST USER_FILM_LIKES (
                                   USER_ID INTEGER,
                                   FILM_ID INTEGER,
...
CREATE TABLE IF NOT EXIST FILM_DIRECTORS (
                              FILM_ID INTEGER,
                              DIRECTOR_ID INTEGER,
...
CREATE TABLE IF NOT EXIST USER_REVIEW_LIKES (
                                   USER_ID INTEGER,
                                   REVIEW_ID INTEGER,
...
CREATE TABLE IF NOT EXIST USER_REVIEW_DISLIKES (
                                   USER_ID INTEGER,
                                   REVIEW_ID INTEGER,
                                   PRIMARY KEY (USER_ID, REVIEW_ID),
...
CREATE TABLE IF NOT EXIST FEED (
                        TIMESTAMP BIGINT,
                        USERID INTEGER,
